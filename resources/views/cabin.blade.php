...
@section('content')
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-dark logocolor">
                  <h4 class="card-title"><b>Cabin</b></h4>
  ...
  <!--   insert data code  -->
<form action="{{url('/insertcabin')}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
...
<form action="{{url('/cabin_update')}}" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        ...
        <div class="modal-body mx-3">
          <input type="hidden" name="id" class="form-control cabin_id validate" required>
          

        <div class="md-form mb-2">
          <label data-error="wrong" data-success="right" for="orangeForm-name" >Warehouse</label>
