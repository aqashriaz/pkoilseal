  ...
  <div class="content">
    <div class="container-fluid">
      <div class="card">
        ...
        <div class="card-body">
          <center>
          <form class="form-horizontal" method="POST" action="{{ url('/invent_threshold_insert') }}">
            @if(session('message'))
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody id="myTable">
                      ...
                      <tr class="text-dark">
                        ...
                        <td><a href="{{url('/invent_threshold/'.$threshold->id.'/delete/')}}" onclick="return confirm('Are you sure you want to delete Threshold?')" name="delete"><i class=" text-danger material-icons">delete</i></a></td>
