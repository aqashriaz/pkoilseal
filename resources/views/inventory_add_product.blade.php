...
" />
    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
              <div class="container">  
                  <a href="" class="text-dark" data-toggle="modal" data-target="#modalRegisterForm"><i class="material-icons" >control_point</i>Add Product</a>

              </div>
            <div class="col-md-12">
              <div class="card">
                  <div class="card-header card-header-tabs card-header-dark logocolor">
                  <h4 class="card-title text-white"><b>Products</b></h4>
                </div>
                  ...
                  <div class="table-responsive">
                    <table class="table" id="example">
                     ...
                     <tr>
                          ...
                          <td><a href="{{url('/invent_product/'.$product->id.'/delete')}}" onclick="return confirm('Are you sure you want to Inactive this product?')" name="delete"><i class=" text-danger material-icons">visibility_off</i></a></td>
                        </tr>
                       @endforeach
                       @endif
                  </tbody>
  ...
  <!--   insert data code  -->
<form action="{{url('/invent_save')}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
...
<select class="form-control" data-toggle="dropdown" name="status" style="width: 100%;">
      ...
      <div class="modal-footer d-flex justify-content-center">
        <input type="submit" class="btn btn-dark logocolor" name="" value="Add Items">
      </div>
    </div>
  </div>
</div>
...
<form action="{{url('invent_product_update')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
    ...
    <div class="modal-content">
      <div class="modal-header text-center">
        ...
        <div class="md-form mb-2">
         ...
         <div class="md-form mb-2">
          <label data-error="wrong" data-success="right" for="orangeForm-name" >Type</label>
          <input type="text" name="type" class="form-control validate type" required>
        </div>
        <div class="md-form mb-2">
          <label data-error="wrong" data-success="right" for="orangeForm-name" >Made In</label>
          <input type="text" name="madein" class="form-control validate madein" required>
        </div>
        <div class="md-form mb-2">
          <label data-error="wrong" data-success="right" for="orangeForm-name" >Brand</label>
          <input type="text" name="brand" class="form-control validate brand" required>
        </div>
        <div class="md-form mb-2">
