    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-12">
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="{{url('/warehouse/'.$warehouse->id.'/delete/')}}" onclick="return confirm('Are you sure you want to delete Warehouse?')" name="delete"><i class="material-icons text-danger">delete</i></td>
                      </tr>
                      @endforeach
                      @endif
                    </tbody>
          ...
          <!--   insert data code  -->
          <form action="{{url('/warehouseinsert')}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
        ...
        <form action="{{url('/warehouse_update')}}" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
