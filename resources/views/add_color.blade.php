  ...
  <div class="content">
    <div class="container-fluid">
      <div class="card">
        ...
        <div class="card-body">
          <center>
          <form class="form-horizontal" method="POST" action="{{ url('/insertcolor') }}">
            @if(session('message'))
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody id="myTable">
                      ...
                      <tr class="text-dark">
                        <td>{{$color->id}}</td>
                        <td>{{$color->color}}</td>
                        <td><a href="{{url('/indexColor/'.$color->id.'/delete/')}}" name="delete" onclick="return confirm('Are you sure you want to delete Color?')" ><i class=" text-danger material-icons">delete</i></a></td>
