...
<body class="">
        ...
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="{{url('/product') }}">
              <i class="material-icons text-dark">photo_album</i>
              <p>Add Product</p>
            </a>
          </li>
          <li class="nav-item ">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="{{url('/cabin')}}">
              <i class="material-icons text-dark">online_prediction</i>
              <p>Add Cabin</p>
            </a>
          </li>
          <li class="nav-item ">
          ...
          <li class="nav-item ">
           ...
           <li class="nav-item ">
            <a class="nav-link" href="{{url('/threshold') }}">
              <i class="material-icons text-dark">build</i>
              <p>Threshold Setting</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="{{url('/indexColor') }}">
              <i class="material-icons text-dark">stop_circle</i>
              <p>Add Color</p>
            </a>
          </li>
           <li class="nav-item ">
            <a class="nav-link" href="{{url('/shortagealert') }}">
              <i class="material-icons text-dark">online_prediction</i>
              <p>Product Shortage Alert</p>
            </a>
          </li>

            <li class="nav-item ">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
          <i class="material-icons text-dark">help_center</i>
          <span>Reports</span>
        </a>
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
              <a class="nav-link" href="{{url('/report_date')}}">
                    <i class="material-icons text-dark">info</i>
                    <p>Sale Reports</p>
                  </a>
                  <a class="nav-link" href="{{url('/profit_index')}}">
                    <i class="material-icons text-dark">info</i>
                    <p>Profit Report</p>
                  </a>
        </div>
           ...
           <li class="nav-item ">
            <a class="nav-link" href="{{url('/invoiceindex')}}">
              <i class="material-icons text-dark">online_prediction</i>
              <p>Invoices Record</p>
            </a>
          </li>
            ...
            <li class="nav-item ">
            <a class="nav-link" href="{{url('/reportViewIndex')}}">
              <i class="material-icons text-dark">timer</i>
              <p>Return Product Record</p>
            </a>
          </li>
          
          <li class="nav-item ">
            <a class="nav-link" href="{{url('/barcode')}}">
              <i class="material-icons text-dark">receipt_long</i>
              <p>Bar Code Print</p>
            </a>
          </li>
  ...
  <script src="public/ajax/libs/core-js/2.4.1/core.js"></script>
  <!-- Library for adding dinamically elements -->
  <script src="public/js/plugins/arrive.min.js"></script>
  <!--  Google Maps Plugin    -->
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB2Yno10-YTnLjjn_Vtk0V8cdcY5lC4plU"></script>
  <!-- Place this tag in your head or just before your close body tag. -->
  <script async defer src="public/buttons.github.io/buttons.js"></script>
  <!-- Chartist JS -->
  ...
  <script src="public/js/material-dashboard.min1c51.js?v=2.1.2" type="text/javascript"></script>
  ...
  <script>
    $(document).ready(function() {
      ...
      ! function(f, b, e, v, n, t, s) {
        ...
        document, 'script', 'public/connect.facebook.net/en_US/fbevents.js');
