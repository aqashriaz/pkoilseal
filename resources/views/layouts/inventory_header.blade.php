...
<body class="">
  ...
  <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="{{url('/invent_Home') }}">
              <i class="material-icons text-dark">dashboard</i>
              <p>Home</p>
            </a>
          </li>
         <li class="nav-item ">
            <a class="nav-link" href="{{url('/invent_product') }}">
              <i class="material-icons text-dark">content_paste</i>
              <p>Add Product</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="{{url('/invent_inventory') }}">
              <i class="material-icons text-dark">library_books</i>
              <p>Inventory</p>
            </a>
          </li>
           <li class="nav-item ">
            <a class="nav-link" href="{{url('/invent_cabin') }}">
              <i class="material-icons text-dark">library_books</i>
              <p>Cabin</p>
            </a>
          </li>
           <li class="nav-item ">
            <a class="nav-link" href="{{url('/index_warehouse')}}">
              <i class="material-icons text-dark">bubble_chart</i>
              <p>Add Warehouse</p>
            </a>
          </li>
           <li class="nav-item ">
            <a class="nav-link" href="{{url('/invent_threshold') }}">
              <i class="material-icons text-dark">build</i>
              <p>Threshold Setting</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="{{url('/invent_color') }}">
